...
function PlayerCarousel({ players, selectedId, onSelect, stats, seasonalHandicaps = {} }: { players: Player[]; selectedId: string | null; onSelect: (id: string) => void; stats?: Record<string, { rank?: unknown; points?: unknown }>; seasonalHandicaps?: Record<string, number> }) {
